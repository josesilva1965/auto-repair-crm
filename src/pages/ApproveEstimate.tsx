                ...
                <div className="bg-white dark:bg-neutral-800 shadow rounded-lg overflow-hidden">
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700">
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tfoot className="bg-gray-50 dark:bg-neutral-900">
                                <tr>
                                    <td colSpan={3} className="px-6 py-3 text-right text-sm font-medium text-gray-500 dark:text-gray-400">{t('subtotal')}</td>
                                    <td className="px-6 py-3 text-right text-sm font-bold text-gray-900 dark:text-white">{estimate.subtotal.toFixed(2)}</td>
                                </tr>
                                <tr>
                                    <td colSpan={3} className="px-6 py-3 text-right text-sm font-medium text-gray-500 dark:text-gray-400">{t('tax')}</td>
                                    <td className="px-6 py-3 text-right text-sm font-bold text-gray-900 dark:text-white">{estimate.tax.toFixed(2)}</td>
                                </tr>
                                <tr>
                                    <td colSpan={3} className="px-6 py-3 text-right text-base font-bold text-gray-900 dark:text-white">{t('total')}</td>
